...
<html lang="fr">
    ...
    <div>
        <!-- LANGAGES -->
        <div class="ppe1">  
            <p class="vttitre">CV FRANCAIS<br></p>
            <img class="ppeimg" src="images/IMG_CV.PNG"><br>
            <a href="images/CV_VIGNALS_Benoit.pdf" ><input type="button" class="btn-success-rouge" value="VOIR PDF" ></a>
        </div>

        <!-- LOGICIELS -->
        <div class="ppe2"> 
            <p class="vttitre">CV ANGLAIS<br></p>
            <img class="ppeimg" src="images/IMG_CV_ANGLAIS.PNG"><br>
            <a href="images/CV_VIGNALS_Benoit_Anglais.pdf" ><input type="button" class="btn-success-rouge" value="VOIR PDF" ></a>
        </div>
    </div>
